...
public class ChatController extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isUserRegistered(context)){
            ...
            startActivity(new Intent(ChatController.this,ChatActivity.class));
            finish();
        ...
        new AsyncTask() {
            ...
            protected String doInBackground(Object[] params) {
                ...
                try {
                    ...
                    if (gcm == null) {
                        gcm = GoogleCloudMessaging.getInstance(ChatController.this);
                    }
