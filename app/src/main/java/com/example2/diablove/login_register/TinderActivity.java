...
public class TinderActivity extends AppCompatActivity implements FlingCardListener.ActionDownInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAppAdapter = new MyAppAdapter(al, TinderActivity.this);
    ...
    public class MyAppAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(TinderActivity.this).load(parkingList.get(position).getImagePath()).into(viewHolder.cardImage);
